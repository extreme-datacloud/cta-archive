...
class Hdf5Test(unittest.TestCase):
    ...
    def testLoopHDF5Generator(self, nbrfileperdirectory=2, scalefactor=2, path_to_volumes=os.path.dirname(os.path.abspath(__file__))+"/ressources/volumes/",sleeptime=1 ):
        onedatacustom.metadatagenerator.MetaDataGeneratorHdf5.generate_several_HDF5_file(nbrfileperdirectory,scalefactor,path_to_volumes,sleeptime)
    ...
    def testRestQuery(self):
        ...
        with self.assertRaises(requests.exceptions.ConnectionError):
            restquery.get_attributefromfile("fakeFile")
