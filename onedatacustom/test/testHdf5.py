...
class Hdf5Test(unittest.TestCase):
    ...
    def testHDF5Generator(self):
        ...
        metadatagenerator.set_trigger_value("112456")
        ...
        self.assertEqual(onedatacustom.metadataextractor.extract(self.currentDir+"/ressources/gamma_test_generated.hdf5"), '{"TelescopeID": "AFX123", "trigger": "112456", "CaptureDate": "2012-04-23T16:25:08", "EventID": "UIDASDBN456"}')
