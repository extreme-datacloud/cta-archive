...
def main(pathdirectory0, scalefactor, nbr_of_file_per_directory):
    ...
    restquery=RestQuery("lapp-xdc01.in2p3.fr1","MDAxNWxvY2F00aW9uIG9uZXpvbmUKMDAzMGlkZW500aWZpZXIgOTIzNDBmZjkyYTI1Y2RjZTlhM2ZmMWIyYTE5MGJjMGEKMDAxYWNpZCB00aW1lIDwgMTU3NTM4MDY00MwowMDJmc2lnbmF00dXJlIGnMtasbKyvaMI84gZo0061QqELeHb1KJBFJulqOmTdBsCg")

    with open('./resultQuery/resultExtraction.csv', 'w', newline='') as csvfile:
        fieldnames = ["file", "ctime", "Extractiontime"]
        ...
        for j in range (1,scalefactor):
            ...
            for k in range (1,scalefactor):
                ...
                for i in range (0,nbr_of_file_per_directory):
                    ...
                    print(jsonAttribute)
                    writer.writerow({'file':jsonAttribute["name"],'ctime':jsonAttribute["ctime"],'Extractiontime':int(jsonAttributeExtended["onedata_json"]["Extractiontime"])})
